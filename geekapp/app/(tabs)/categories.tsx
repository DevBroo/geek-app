...
const Categories = () => {
  ...
  const modelsByBrand: Record<string, Model[]> = {
    'Dell': [
      { id: 1, name: 'XPS 13', image: require('../../assets/images/geeklappylogo.png'), specs: ['Intel i7', '16GB RAM', '512GB SSD'], price: 1299 },
      { id: 2, name: 'Inspiron 15', image: require('../../assets/images/geeklappylogo.png'), specs: ['Intel i5', '8GB RAM', '256GB SSD'], price: 699 },
      { id: 3, name: 'Alienware m15', image: require('../../assets/images/geeklappylogo.png'), specs: ['Intel i9', '32GB RAM', '1TB SSD', 'RTX 3080'], price: 2199 },
      { id: 4, name: 'Latitude 14', image: require('../../assets/images/geeklappylogo.png'), specs: ['Intel i5', '16GB RAM', '512GB SSD'], price: 999 },
    ],
    'HP': [
      { id: 1, name: 'Spectre x360', image: require('../../assets/images/geeklappylogo.png'), specs: ['Intel i7', '16GB RAM', '1TB SSD'], price: 1399 },
      { id: 2, name: 'Pavilion 15', image: require('../../assets/images/geeklappylogo.png'), specs: ['AMD Ryzen 5', '8GB RAM', '512GB SSD'], price: 649 },
      { id: 3, name: 'Envy 13', image: require('../../assets/images/geeklappylogo.png'), specs: ['Intel i7', '16GB RAM', '512GB SSD'], price: 1099 },
    ],
    'Lenovo': [
      { id: 1, name: 'ThinkPad X1', image: require('../../assets/images/geeklappylogo.png'), specs: ['Intel i7', '16GB RAM', '1TB SSD'], price: 1599 },
      { id: 2, name: 'Yoga 9i', image: require('../../assets/images/geeklappylogo.png'), specs: ['Intel i7', '16GB RAM', '512GB SSD'], price: 1299 },
      { id: 3, name: 'IdeaPad 5', image: require('../../assets/images/geeklappylogo.png'), specs: ['AMD Ryzen 7', '16GB RAM', '512GB SSD'], price: 799 },
    ],
    'Apple': [
      { id: 1, name: 'MacBook Pro 14"', image: require('../../assets/images/geeklappylogo.png'), specs: ['M1 Pro', '16GB RAM', '512GB SSD'], price: 1999 },
      { id: 2, name: 'MacBook Air', image: require('../../assets/images/geeklappylogo.png'), specs: ['M2', '8GB RAM', '256GB SSD'], price: 1199 },
      { id: 3, name: 'MacBook Pro 16"', image: require('../../assets/images/geeklappylogo.png'), specs: ['M1 Max', '32GB RAM', '1TB SSD'], price: 2499 },
    ],
    'Samsung': [
      { id: 1, name: 'Galaxy S23 Ultra', image: require('../../assets/images/geeklappylogo.png'), specs: ['Snapdragon 8 Gen 2', '12GB RAM', '512GB Storage'], price: 1199 },
      { id: 2, name: 'Galaxy Z Fold 5', image: require('../../assets/images/geeklappylogo.png'), specs: ['Snapdragon 8 Gen 2', '12GB RAM', '256GB Storage'], price: 1799 },
      { id: 3, name: 'Galaxy A53', image: require('../../assets/images/geeklappylogo.png'), specs: ['Exynos 1280', '6GB RAM', '128GB Storage'], price: 449 },
    ],
  };
  ...
  const companiesByCategory: Record<string, Company[]> = {
    'Laptop': [
      { id: 1, name: 'Dell', logo: require('../../assets/images/geeklappylogo.png') },
      { id: 2, name: 'HP', logo: require('../../assets/images/geeklappylogo.png') },
      { id: 3, name: 'Lenovo', logo: require('../../assets/images/geeklappylogo.png') },
      { id: 4, name: 'Apple', logo: require('../../assets/images/geeklappylogo.png') },
      { id: 5, name: 'Asus', logo: require('../../assets/images/geeklappylogo.png') },
      { id: 6, name: 'Acer', logo: require('../../assets/images/geeklappylogo.png') },
      { id: 7, name: 'MSI', logo: require('../../assets/images/geeklappylogo.png') },
      { id: 8, name: 'Microsoft', logo: require('../../assets/images/geeklappylogo.png') },
    ],
    'CCTV': [
      { id: 1, name: 'Hikvision', logo: require('../../assets/images/geeklappylogo.png') },
      { id: 2, name: 'Dahua', logo: require('../../assets/images/geeklappylogo.png') },
      { id: 3, name: 'Axis', logo: require('../../assets/images/geeklappylogo.png') },
      { id: 4, name: 'Bosch', logo: require('../../assets/images/geeklappylogo.png') },
      { id: 5, name: 'Hanwha', logo: require('../../assets/images/geeklappylogo.png') },
    ],
    'PC': [
      { id: 1, name: 'Dell', logo: require('../../assets/images/geeklappylogo.png') },
      { id: 2, name: 'HP', logo: require('../../assets/images/geeklappylogo.png') },
      ...
      { id: 6, name: 'Acer', logo: require('../../assets/images/geeklappylogo.png') },
      { id: 7, name: 'MSI', logo: require('../../assets/images/geeklappylogo.png') },
      { id: 8, name: 'Alienware', logo: require('../../assets/images/geeklappylogo.png') },
    ],
    'Mobile': [
      { id: 1, name: 'Apple', logo: require('../../assets/images/geeklappylogo.png') },
      { id: 2, name: 'Samsung', logo: require('../../assets/images/geeklappylogo.png') },
      { id: 3, name: 'Google', logo: require('../../assets/images/geeklappylogo.png') },
      { id: 4, name: 'Xiaomi', logo: require('../../assets/images/geeklappylogo.png') },
      { id: 5, name: 'OnePlus', logo: require('../../assets/images/geeklappylogo.png') },
      { id: 6, name: 'Oppo', logo: require('../../assets/images/geeklappylogo.png') },
      { id: 7, name: 'Vivo', logo: require('../../assets/images/geeklappylogo.png') },
      { id: 8, name: 'Motorola', logo: require('../../assets/images/geeklappylogo.png') },
    ],
    'Accessories': [
    ...
    'Printers': [
      { id: 1, name: 'HP', logo: require('../../assets/images/geeklappylogo.png') },
    ...
    'Mouse': [
      ...
      { id: 4, name: 'Corsair', logo: require('../../assets/images/geeklappylogo.png') },
      { id: 5, name: 'Microsoft', logo: require('../../assets/images/geeklappylogo.png') },
    ],
    'Keyboard': [
      { id: 1, name: 'Logitech', logo: require('../../assets/images/geeklappylogo.png') },
      { id: 2, name: 'Razer', logo: require('../../assets/images/geeklappylogo.png') },
    ...
    'Monitors': [
      { id: 1, name: 'Dell', logo: require('../../assets/images/geeklappylogo.png') },
      { id: 2, name: 'LG', logo: require('../../assets/images/geeklappylogo.png') },
      { id: 3, name: 'Samsung', logo: require('../../assets/images/geeklappylogo.png') },
      { id: 4, name: 'Asus', logo: require('../../assets/images/geeklappylogo.png') },
      { id: 5, name: 'Acer', logo: require('../../assets/images/geeklappylogo.png') },
    ...
    'Speakers': [
      ...
      { id: 4, name: 'Logitech', logo: require('../../assets/images/geeklappylogo.png') },
